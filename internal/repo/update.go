...
func (a *appStoreRepo) repoUpdate(names string, out io.Writer) error {
	o := &repoUpdateOptions{update: updateCharts}
	settings := cli.New()
	settings.Debug = true
	// set namespace
	settings.RepositoryConfig = a.cfg.Helm.RepoFile
	settings.RepositoryCache = a.cfg.Helm.RepoCache

	o.repoFile = a.cfg.Helm.RepoFile
	o.repoCache = a.cfg.Helm.RepoCache
